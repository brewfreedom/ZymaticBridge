        ...
        public void ParseRequest(ReadOnlySequence<byte> buffer, out SequencePosition consumed, out SequencePosition examined)
        {
            ...
            switch (_requestProcessingStatus)
            {
                ...
                case RequestProcessingStatus.ParsingHeaders:
                    ...
                    //Picobrew sends us non compliant header
                    //Just ignore them like they ignore Zymatic owners
                    //There are a few requests for Kestrel to change this behavior
                    //I played around a bit to work around the crap but ultimately felt this was a better route
                    //TakeMessageHeaders(buffer, out consumed, out examined);
